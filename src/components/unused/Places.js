      ...
      <section class="place section" id="place">
        ...
        <div class="place__container container grid">
          ...
          <div class="place__card">
            <img src={place1} alt="" class="place__img" />
          ...
          {/* <!--==================== PLACES CARD 2 ====================--> */}
          <div class="place__card">
            <img src={place2} alt="" class="place__img" />
          ...
          {/* <!--==================== PLACES CARD 3 ====================--> */}
          <div class="place__card">
            <img src={place3} alt="" class="place__img" />
          ...
          {/* <!--==================== PLACES CARD 4 ====================--> */}
          <div class="place__card">
            <img src={place4} alt="" class="place__img" />
          ...
          {/* <!--==================== PLACES CARD 5 ====================--> */}
          <div class="place__card">
            <img src={place5} alt="" class="place__img" />
